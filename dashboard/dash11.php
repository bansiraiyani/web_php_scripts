    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/bansi-raiyani/home" target="_blank">Google Site</a></li>
                    <li class="list-group-item"><a href="https://www.linkedin.com/in/bansi-raiyani-17aa37289/" target="_blank">LinkedIn</a></li>
                    <li class="list-group-item"><a href="https://www.blog.com" target="_blank">Blog</a></li>
                    <li class="list-group-item"><a href="https://github.com/bansiraiyani/web_php_scripts" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                ...
                <div class="container">
                    <div class="dashboard-item">
                        ...
                        <p>My name is bansi raiyani. I graduated with a Computer degree in 2023 in m.v.m college I had worked with  as php developer </p>
                    </div>
                    <div class="dashboard-item">
                        <div id="my-skillset" class="section-title">
                            <h2>My Skillset</h2>
                        </div>
                        <p>php,asp.net,html,sql</p>
                    </div>
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button"><a href="https://github.com/bansiraiyani/web_php_scripts/tree/main/task_1">Task 1</a></button>
                            <button class="sunset-orange-button gradient-button"><a href="https://github.com/bansiraiyani/web_php_scripts/tree/main/task_2">Task 2</a></button>
                            <button class="spring-green-button gradient-button"><a href="https://github.com/bansiraiyani/web_php_scripts/tree/main/task3">Task 3</a></button>
